...
export class HlmTabsPaginatedListComponent extends BrnTabsPaginatedListDirective {
  ...
  public readonly _tabListContainer =
    viewChild.required<ElementRef>('tabListContainer');
  public readonly _tabList = viewChild.required<ElementRef>('tabList');
  public readonly _tabListInner =
    viewChild.required<ElementRef>('tabListInner');
  public readonly _nextPaginator =
    viewChild.required<ElementRef>('nextPaginator');
  public readonly _previousPaginator =
    viewChild.required<ElementRef>('previousPaginator');
